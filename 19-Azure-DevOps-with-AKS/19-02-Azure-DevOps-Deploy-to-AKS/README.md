...
- Select a Repository: "select your repo" (your-/azure-devops-github-acr-aks-app1)
- Configure your pipeline: Deploy to Azure Kubernetes Service
- Select Subscription: your--paid-subscription (select your subscription)
...
- stage: Deploy
  ...
  - deployment: Deploy
    ...
    pool:
      vmImage: $(vmImageName)
    environment: 'your-azuredevopsgithubacraksapp1internal-1561.default'
    strategy:
      runOnce:
        deploy:
          steps:

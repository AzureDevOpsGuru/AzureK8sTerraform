...
kubectl create deployment my-backend-rest-app --image=your-image/kube-helloworld:1.0.0 
kubectl get deploy
...
- **Backend HelloWorld Application Source** [kube-helloworld](https://github.com/your-image/kubernetes-fundamentals/tree/master/00-Docker-Images/02-kube-backend-helloworld-springboot/kube-helloworld)
...
- **Important Note:** In Nginx reverse proxy, ensure backend service name `my-backend-service` is updated when you are building the frontend container. We already built it and put ready for this demo (your-image/kube-frontend-nginx:1.0.0)
- **Nginx Conf File**
```conf
server {
    listen       80;
...
```
- **Docker Image Location:** https://hub.docker.com/repository/docker/your-image/kube-frontend-nginx
- **Frontend Nginx Reverse Proxy Application Source** [kube-frontend-nginx](https://github.com/your-image/kubernetes-fundamentals/tree/master/00-Docker-Images/03-kube-frontend-nginx)
```
# Create Deployment for Frontend Nginx Proxy
kubectl create deployment my-frontend-nginx-app --image=your-image/kube-frontend-nginx:1.0.0 
kubectl get deploy

...
- **Docker Image Location:** https://hub.docker.com/repository/docker/your-image/kubenginx
```
# Create Deployment
kubectl create deployment <Deplyment-Name> --image=<Container-Image>
kubectl create deployment my-first-deployment --image=your-image/kubenginx:1.0.0 
